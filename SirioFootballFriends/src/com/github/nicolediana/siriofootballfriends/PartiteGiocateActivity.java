...
public class PartiteGiocateActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_partite_giocate);
		...
		try {			 
		     ...
		     ListView mylist = (ListView) findViewById(R.id.elencoPartiteGiocate); 
			 ...
			 public void onItemClick(AdapterView<?> adapter, final View view, int pos, long id){  
			    ...
			    intent.putExtra("visibilitàPulsanti", "invisibili");
